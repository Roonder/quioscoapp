    ...
    <>
        <div className="shadow p-5 mb-3 flex gap-10 items-center">
            ...
            <div className="md:w-4/6">
                ...
                <p className="text-xl text-amber-500 mt-2 font-bold">Precio: {formatearDinero(producto.precio)}</p>
                <p className="text-sm text-gray-700 mt-2 font-bold">Subtotal: {formatearDinero(producto.precio * producto.cantidad)}</p>
            </div>
